          ...
          <div className="flex justify-between items-end">
            <div className="flex items-end gap-3">
              <Link className="inline-block" href="https://www.clubduelz.in/" target="_blank">
                <Image src="/companies/clubduelz.jpg" alt="Club Duelz" width={1000} height={1000} priority draggable={false} className="rounded-lg h-15 w-15 border border-dashed hover:border-primary" />
              </Link>

...
const ProfileSection = () => {
  ...
  return (
    <div className="flex w-full h-38 items-end">
        <div className="relative border dark:border-zinc-700 min-w-38">
            <Profile height={150} width={150} className={`rounded-full border dark:border-zinc-700 p-0.5 leading-none ${gradient}`} />
            <Active />
        </div>
        <div className="flex flex-col justify-end h-full w-full">
            <div className={`w-full h-full ${gradient}`}></div>
            <div className="flex w-full h-35 justify-between items-center px-4 border border-b-0 border-l-0 dark:border-zinc-700">
